import { generateQuestionsOutputSchema } from '../utils/aiValidation';

const LLM_API_KEY = process.env.LLM_API_KEY!;

export const generateInterviewQuestions = async (role: string, difficulty: string, count: number) => {
  ...
  try {
    ...
    const validatedData = generateQuestionsOutputSchema.parse(parsedData);
