...
exports.setupInterviewSockets = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const redis_1 = __importDefault(require("../services/redis"));
const prisma_1 = __importDefault(require("../db/prisma"));
const JWT_SECRET = process.env.JWT_SECRET || 'fallback_secret';
const setupInterviewSockets = (io) => {
    ...
    io.on('connection', (socket) => {
        ...
        socket.on('start_session', async (payload) => {
            try {
                ...
                if (redis_1.default.isOpen) {
                    await redis_1.default.set(sessionKey, JSON.stringify(sessionState), { EX: 1800 });
                }
        ...
        socket.on('submit_answer', async (payload) => {
            try {
                ...
                if (redis_1.default.isOpen) {
                    const rawSession = await redis_1.default.get(sessionKey);
                    if (rawSession)
...
exports.setupInterviewSockets = setupInterviewSockets;
